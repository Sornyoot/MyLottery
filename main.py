...
class MainScreen(Screen):
    ...
    def screengrab(self, *largs):
        Window.screenshot(name='images/screen_1.jpg')
    ...
    def click(self, *args):
        try:
            location = pyautogui.locateOnScreen('images/4.png')
            pyautogui.click(location)
        except pyautogui.ImageNotFoundException:
            print('not pass')
        try:
            location = pyautogui.locateOnScreen('images/5.png')
            pyautogui.click(location)
        except pyautogui.ImageNotFoundException:
            print('not pass')
        try:
            location = pyautogui.locateOnScreen('images/1.png')
            pyautogui.click(location)
            pyautogui.click(location)
            location = pyautogui.locateOnScreen('images/2.png')
            pyautogui.click(location)
            pyautogui.click(location)
            location = pyautogui.locateOnScreen('images/3.png')
            pyautogui.click(location)
            pyautogui.click(location)
        except pyautogui.ImageNotFoundException:
            print('not pass')
...
class Pass_1(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        images = glob.glob('images/screen_10001.jpg')
    ...
    def Crop_1(self, obj, touch):
        image = Image.open('images/screen_10001.jpg')
        x = touch.x - 20
        y = touch.y - 20
        xw = x + 40
        yh = y + 40
        crop = image.crop((x, y, xw, yh))
        crop.save('images/1.png', quality=200)
...
class Pass_2(Screen):
    ...
    def Crop_2(self, obj, touch):
        ...
        yh = y + 40
        crop = image.crop((x, y, xw, yh))
        crop.save('images/2.png', quality=200)
        print('x =', x, 'y =', y, 'xw =', xw, 'yh =', yh)
...
class Pass_3(Screen):
    ...
    def Crop_3(self, obj, touch):
        ...
        yh = y + 40
        crop = image.crop((x, y, xw, yh))
        crop.save('images/3.png', quality=200)
        print('x =', x, 'y =', y, 'xw =', xw, 'yh =', yh)
...
class Pass_4(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        images = glob.glob('images/screen_10002.jpg')
        for img in images:
            thumb = kiImage(source=img)
    ...
    def Crop_4(self, obj, touch):
        image = Image.open('images/screen_10002.jpg')
        x = touch.x - 20
        y = 534 - touch.y - 20
        xw = x + 40
        yh = y + 40
        crop = image.crop((x, y, xw, yh))
        crop.save('images/4.png', quality=200)
        print('x =', x, 'y =', y, 'xw =', xw, 'yh =', yh)
...
class Pass_5(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        images = glob.glob('images/screen_10003.jpg')
        for img in images:
            thumb = kiImage(source=img)
    ...
    def Crop_5(self, obj, touch):
        image = Image.open('images/screen_10003.jpg')
        x = touch.x - 20
        y = 534 - touch.y - 20
        xw = x + 40
        yh = y + 40
        crop = image.crop((x, y, xw, yh))
        crop.save('images/5.png', quality=200)
        print('x =', x, 'y =', y, 'xw =', xw, 'yh =', yh)
